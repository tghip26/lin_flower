...
export default function HomePage() {
  ...
  return (
    <PageTransition>
      <div className="relative space-y-12 sm:space-y-20 lg:space-y-24 pb-16 sm:pb-24 overflow-hidden">
        
        {/* Background Glowing Floral Vine SVG Path Spanning Top to Bottom */}
        <FloralVineBackground />

        {/* 1. Hero Banner Section */}
        <section className="relative z-10 pt-2 sm:pt-4 pb-6 sm:pb-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              >
                {/* Top Badge */}
                <div className="inline-flex items-center gap-2 bg-white/95 backdrop-blur-xl text-brand-900 text-xs sm:text-sm font-semibold px-4.5 py-2 rounded-full border border-amber-200/80 shadow-xs max-w-full">
                  <Sparkles className="w-4 h-4 text-amber-500 flex-shrink-0 animate-spin" />
                  <span className="tracking-wide truncate">Tiệm Hoa Tươi Cao Cấp Quế Võ - Bắc Ninh</span>
                </div>

                {/* Hero Title & Slogan */}
                <div className="space-y-2.5 sm:space-y-3.5">
                  <h1 className="font-serif font-semibold text-4xl sm:text-6xl lg:text-7xl text-stone-900 leading-[1.08] tracking-tight">
                  ...
                  <p className="font-serif italic text-lg sm:text-xl lg:text-2xl text-brand-700 tracking-wide font-normal">
                    TRAO TRỌN YÊU THƯƠNG – GỬI TRỌN TÂM Ý ♡
                  </p>
                </div>

                {/* Description Box */}
                <p className="text-stone-700 text-xs sm:text-base leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal bg-white/85 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-pink-100/90 shadow-xs">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 sm:gap-3 text-xs font-semibold">
                  <div className="flex items-center gap-2 bg-white/95 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-full border border-pink-100 text-stone-800 shadow-2xs">
                ...
                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 sm:gap-4.5 pt-3 sm:pt-4">
                  <Link
                    href="/products"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-brand-600 via-brand-500 to-rose-600 hover:from-brand-700 hover:to-rose-700 text-white font-semibold text-sm sm:text-base px-7.5 py-4 sm:px-9 sm:py-4 rounded-full shadow-pink-soft hover:shadow-pink-glow active:scale-95 transition-all tracking-wide"
                  >
                  ...
                  <Link
                    href="/custom-order"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-white/95 backdrop-blur-md hover:bg-stone-50 text-stone-800 font-semibold text-sm sm:text-base px-7.5 py-4 sm:px-9 sm:py-4 rounded-full border-2 border-brand-200 hover:border-brand-400 active:scale-95 transition-all shadow-xs"
                  >
                ...
                {/* Contact info pill */}
                <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-3.5 text-xs font-semibold text-stone-600">
              ...
              >
                <div className="relative mx-auto max-w-md lg:max-w-none overflow-hidden rounded-[2.5rem] shadow-xl aspect-[4/3] sm:aspect-square group border border-pink-100">
                  <img
        ...
        <div className="relative z-10 flex items-center justify-center my-3 sm:my-6">
          <div className="flex items-center gap-3 bg-white/90 backdrop-blur-md px-6 py-2.5 rounded-full border border-pink-200 shadow-xs">
        ...
        {/* 3. BEST SELLERS & CATEGORY TABS WITH AMPLE BREATHING ROOM */}
        <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 sm:gap-8 border-b border-pink-100 pb-5 sm:pb-6">
            ...
            <div className="flex flex-wrap gap-2.5 sm:gap-3">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2.5 sm:px-5 sm:py-3 rounded-full text-xs font-semibold transition-all cursor-pointer ${
                    activeTab === tab.id
          ...
          {/* Products Grid with Generous Spacing (gap-7 sm:gap-8) */}
          ...
          <div className="text-center pt-6 sm:pt-8">
            <Link
              href="/products"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-brand-600 via-rose-500 to-amber-500 hover:from-brand-700 hover:to-amber-600 text-white font-bold text-sm sm:text-base px-8 py-4 sm:px-10 sm:py-4.5 rounded-full shadow-pink-soft hover:shadow-pink-glow active:scale-95 transition-all tracking-wide"
            >
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-brand-800 via-rose-800 to-brand-900 text-white rounded-[2.5rem] p-7 sm:p-14 lg:p-16 shadow-2xl border border-pink-300/30 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-10">
            <div className="space-y-4 sm:space-y-5 max-w-2xl text-center md:text-left z-10">
        ...
        <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7 sm:gap-8">
            {reviews.slice(0, 3).map((rev) => (
              <div key={rev.id} className="bg-white/95 backdrop-blur-md p-6.5 sm:p-8 rounded-[2rem] border border-pink-200/80 shadow-sm hover:shadow-xl hover:border-pink-300 transition-all space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="flex items-center justify-between border-b border-pink-100 pb-3">
                    ...
                    <span className="text-[11px] sm:text-xs text-stone-400 font-mono">{rev.createdAt}</span>
                  </div>
