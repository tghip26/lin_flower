...
import { 
  ...
  Flower2, Star, CheckCircle, PhoneCall, MapPin, Eye 
} from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                <div className="bg-white/80 p-3 rounded-2xl border border-brand-100 shadow-sm text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                <Link
                  href="/products"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-700 hover:to-brand-600 text-white font-bold text-base px-8 py-4 rounded-full shadow-pink-soft hover:shadow-pink-glow transition-all"
                >
                ...
                <Link
                  href="/custom-order"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-stone-50 text-stone-800 font-bold text-base px-7 py-4 rounded-full border-2 border-brand-200 hover:border-brand-400 transition-all shadow-sm"
                >
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs font-semibold text-stone-600">
                <a href="tel:0363819228" className="flex items-center gap-1.5 text-brand-700 hover:underline">
      ...
      {/* FLOWER MENU SECTION (Visual Match ofPrompt Banner) */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((cat) => (
            <Link
              ...
              className="group bg-white rounded-3xl p-6 border border-brand-100/80 shadow-sm hover:shadow-xl hover:border-brand-300 transition-all duration-300 flex flex-col justify-between"
            >
              <div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-4">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold transition-all ${activeTab === tab.id ? 'bg-brand-600 text-white shadow-pink-soft' : 'bg-stone-100 text-stone-700 hover:bg-stone-200'}`}
              >
                {tab.label}
              </button>
            ))}
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4 text-center lg:text-left">
              ...
              <div className="pt-2">
                <Link
                  href="/custom-order"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-stone-950 font-bold px-8 py-3.5 rounded-full shadow-lg transition-all"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reviews.map((rev) => (
            <div key={rev.id} className="bg-white rounded-3xl p-6 border border-brand-100 shadow-sm space-y-4">
