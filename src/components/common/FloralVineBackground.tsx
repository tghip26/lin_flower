  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden select-none">
      ...
      <div className="absolute inset-0">
        {[
          { top: '10%', left: '18%', delay: 0, duration: 7, size: 'text-2xl' },
          { top: '26%', left: '82%', delay: 2, duration: 8, size: 'text-xl' },
          { top: '44%', left: '12%', delay: 1, duration: 9, size: 'text-3xl' },
          { top: '60%', left: '88%', delay: 3, duration: 7.5, size: 'text-2xl' },
          { top: '78%', left: '22%', delay: 1.5, duration: 8.5, size: 'text-xl' },
          { top: '90%', left: '78%', delay: 0.5, duration: 9.5, size: 'text-3xl' },
        ].map((petal, idx) => (
          <motion.div
            key={idx}
